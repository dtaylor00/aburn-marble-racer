...
class WOPhysicsTrack : public WOPhysicsTriangleMesh, public IFaceWOTrack {
   public:
    ...
    static WOPhysicsTrack* New(const std::string& trackName, const std::string& modelFileName, Vector scale = Vector(1, 1, 1), MESH_SHADING_TYPE shadingType = MESH_SHADING_TYPE::mstFLAT, physx::PxActorType::Enum actorType = physx::PxActorType::eRIGID_STATIC);
