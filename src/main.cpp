...
#include <vector>
#include <memory>
#include "GLViewMarbleRacer.h" //GLView subclass instantiated to drive this simulation
...
int main( int argc, char* argv[] )
{
   ...
   do
   {
      std::unique_ptr< Aftr::GLViewMarbleRacer > glView( Aftr::GLViewMarbleRacer::New( args ) );
